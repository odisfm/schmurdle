...
class AccountController {
    ...
    isWordOfDay(){
        if (!(0,date_fns__WEBPACK_IMPORTED_MODULE_3__.isToday)(this.user.lastPlayed) || this.user.lastPlayed === null){
            return true
        }
        return false
    }
